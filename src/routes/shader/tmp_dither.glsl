...
uniform vec2 u_checkboxes;// Checkboxes

// Constants
#define PI 3.1415925359
#define TWO_PI 6.2831852
#define MAX_STEPS 3000// Mar Raymarching steps
...
void main()
{
    ...
    gl_FragColor = vec4(0.0, 0.0, dither8x8(gl_PointCoord*u_checkboxes, color.r), 1.0);
